#################################################################################
# Nombre del programa:	MD_EILU_GRAD_2019.R                                          
# Autor:              	INE
# Version:            	4.1
# Última modificación: 	15 septiembre 2017
#                                                                                
# Descripción: 
#	Este programa procesa un fichero de microdatos (md_EILU_GRAD_2019.txt)
#   a partir de un fichero de metadatos (dr_EILU_GRAD_2019.xlsx) que contiene 
#   el diseño de registro del archivo de microdatos. 
#     EILU_GRADUADOS: Operación estadaístic
#     2019: Año(s) de producción de los datos
#
# Entrada:                                                           
#     - Diseño de registro: 	dr_EILU_GRAD_2019.xlsx
#     - Archivo de microdatos: 	md_EILU_GRAD_2019.txt
# Salida: 
...
fichero_micro <- "md_EILU_GRAD_2019.txt"
fichero_meta  <- "dr_EILU_GRAD_2019.xlsx"
